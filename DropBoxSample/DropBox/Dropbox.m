...
static NSString *apiKey = @"Your app api key";
static NSString *appSecret = @"Your app secret key";
...
+ (NSURL*)appRootURL
{
    NSString *url = [NSString stringWithFormat:@"https://api.dropbox.com/1/metadata/dropbox/%@/photos",appFolder];
